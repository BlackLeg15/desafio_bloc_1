...
import 'package:desafio_bloc_1/app/modules/home/presenter/pages/home/bloc/events/blog_posts_events.dart';
import 'package:desafio_bloc_1/app/modules/home/presenter/pages/home/bloc/states/blog_posts_state.dart';
  ...
  group(
    ...
    () {
      ...
      blocTest<BlogPostsBloc, BlogPostsStateFreezed>(
        ...
        act: (bloc) => bloc.add(const BlogPostsEvent.get()),
        expect: () => [
